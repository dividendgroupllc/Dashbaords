...
def _get_product_comparison_rows(years: list[int], month_numbers: list[int], item_limit: int = 26) -> list[dict[str, Any]]:
...
@frappe.whitelist()
@dashboard_cache("product_comparison")
def get_dashboard_context():
    ...
    month_sections = _get_product_comparison_rows(years, month_numbers)
