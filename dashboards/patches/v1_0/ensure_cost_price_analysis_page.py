...
PAGE_NAME = "cost-price-analysis"
PAGE_TITLE = "Себестоимость продукции"
ANCHOR_PAGE = "manufacture-dashboard"
...
def ensure_workspace_link():
    ...
    # Себестоимость логически продолжает производственный дашборд — ставим сразу после него.
